...
DROP TABLE IF EXISTS public.polling_settings CASCADE;
DROP TABLE IF EXISTS public.telemetry_events CASCADE;
DROP TABLE IF EXISTS public.temp_charging_sessions CASCADE;
DROP TABLE IF EXISTS public.vehicle_snapshots CASCADE;
